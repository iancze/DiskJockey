...
if args.model == "vertical":
    ...
    # Also set parameters to a reasonable dictionary
    config["parameters"] = {"M_star": 1.03, "PA": 152.0, "T_10a": 91.85, "T_10m": 20.85, "dpc": 145.0, "gamma": 1.0, "incl": 45.0, "ksi": 0.2, "logM_gas": -1.0, "mu_DEC": 0.0, "mu_RA": 0.0, "q_m": 0.5, "q_a": 0.5, "r_c": 500.0, "vel": -1.6, "T_freeze": 19., "X_freeze": 0.01, "sigma_s": 0.706, "h": 4.0, "delta":2.0 }
